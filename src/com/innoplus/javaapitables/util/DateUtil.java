...
public class DateUtil {
	...
	public static boolean isHoliday(Calendar paramCalendar) {
		int i = paramCalendar.get(Calendar.MONTH);
		int j = paramCalendar.get(Calendar.DAY_OF_MONTH);
		if ((i == Calendar.JULY) && (j == 4)) {
			return true;
		}
		if ((i == Calendar.DECEMBER) && (j == 25)) {
			return true;
		}

		return (i == Calendar.JANUARY) && (j == 1);
	}
	...
	public static boolean isWeekend(Calendar paramCalendar) {
		int i = paramCalendar.get(Calendar.DAY_OF_WEEK);
	...
	public static Calendar setToEndOfDay(Calendar paramCalendar) {
		...
		paramCalendar.set(Calendar.MILLISECOND, 999);
	...
	public static void setTo3rdFridayOfTheMonth(Calendar paramCalendar) {
		...
		paramCalendar.add(Calendar.DAY_OF_MONTH, 14);

		int j = 6 - i + (i > 6 ? 7 : 0);
		paramCalendar.add(Calendar.DAY_OF_MONTH, j);
	...
	public static void setToSaturdayFollowing3rdFridayOfTheMonth(Calendar paramCalendar) {
		...
		paramCalendar.add(Calendar.DAY_OF_MONTH, 1);
	}
}